...
<p align="center"><img src="https://git.fiduswriter.org/fiduswriter/fwtoolkit/raw/branch/main/demo/logo.svg" alt="fwtoolkit logo" width="100" height="100"></p>
...
Live demos are published on Forgejo Pages:
...
with the target URL `https://fiduswriter.pages.fiduswriter.org/fwtoolkit` and branch
filter `pages`.
