...
export class DropUp {
    constructor(options) {
        ...
        this.listElement = this.element.querySelector(".fw-drop-up-options");
        this.bindEvents();
    }
    buildElement() {
    ...
    bindEvents() {
        const options = Array.from(this.listElement.querySelectorAll(".fw-drop-up-option"));
...
//# sourceMappingURL=drop_up.js.map