...
export function setupPassphraseDialog(onSetup) {
    return new Promise(resolve => {
        ...
        const buttons = [
            {
                ...
                click: async () => {
                    ...
                    const confirmInput = document.getElementById("e2ee-confirm-passphrase-input");
                    const errorEl = document.getElementById("e2ee-passphrase-error");
                    ...
                    if (passphrase.length < 8) {
                        if (errorEl) {
                            errorEl.textContent = gettext("Passphrase must be at least 8 characters long.");
                        }
                        return;
                    }
                    if (passphrase !== confirmPassphrase) {
                        if (errorEl) {
                            errorEl.textContent = gettext("Passphrases do not match.");
                        }
                        return;
                    }
        ...
        setTimeout(() => {
            const toggleBtns = document.querySelectorAll(`#${dialogId} .e2ee-toggle-visibility`);
            ...
            const passphraseInput = document.getElementById("e2ee-passphrase-input");
            if (passphraseInput) {
 ...
 * @returns Promise that resolves when the dialog closes
 */
export function enterPassphraseDialog(onUnlock, onRecover = null, options = {}) {
    return new Promise(resolve => {
        ...
        const buttons = [
            {
                ...
                click: () => {
                    ...
                    if (passphrase.length === 0) {
                        const errorEl = document.getElementById("e2ee-passphrase-error");
                        if (errorEl) {
                            errorEl.textContent = gettext("Please enter your passphrase.");
                        }
                        return;
                    }
                    dialogInstance.close();
        ...
        dialogInstance.open();
        setTimeout(() => {
            const toggleBtn = document.querySelector(`#${dialogId} .e2ee-toggle-visibility`);
            const input = document.getElementById("e2ee-passphrase-input");
            if (toggleBtn && input) {
        ...
        const buttons = [
            {
                ...
                classes: "fw-button fw-dark",
                click: () => {
                    const recoveryInput = document.getElementById("e2ee-recovery-key-input");
                    const newInput = document.getElementById("e2ee-new-passphrase-input");
                    const confirmInput = document.getElementById("e2ee-confirm-passphrase-input");
                    const errorEl = document.getElementById("e2ee-recover-error");
                    ...
                    if (recoveryKey.length === 0) {
                        if (errorEl) {
                            errorEl.textContent = gettext("Please enter your recovery key.");
                        }
                        return;
                    }
        ...
        const buttons = [
            {
                ...
                classes: "fw-button fw-dark",
                click: async () => {
                    const oldInput = document.getElementById("e2ee-old-passphrase-input");
                    const newInput = document.getElementById("e2ee-new-passphrase-input");
                    const confirmInput = document.getElementById("e2ee-confirm-new-passphrase-input");
                    ...
                    if (oldPassphrase.length === 0) {
                        if (errorEl) {
                            errorEl.textContent = gettext("Please enter your current passphrase.");
                        }
                        return;
                    }
                    if (newPassphrase.length < 8) {
...
//# sourceMappingURL=passphrase-dialog.js.map