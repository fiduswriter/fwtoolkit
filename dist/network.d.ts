...
export declare const get: (url: string, params?: Record<string, string>, csrfToken?: string | false) => Promise<Response>;
export declare const getJson: (url: string, params?: Record<string, string>, csrfToken?: string | false) => Promise<unknown>;
