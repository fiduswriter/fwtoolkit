...
export class WebSocketConnector {
    ...
    initialMessage = () => ({ type: "subscribe" }), resubScribed = () => { }, // Cleanup when the client connects a second or subsequent time
    ...
    onmessage(event) {
        ...
        if (data.type === "request_resend") {
            ...
            // Request resend.
            this.waitForWS()
                .then(() => this.ws.send(JSON.stringify({
                type: "request_resend",
